...
public class AdaptadorMenu
        extends RecyclerView.Adapter<AdaptadorMenu.MiViewHolder> implements View.OnClickListener {
    ...
    @Override
    public MiViewHolder onCreateViewHolder( ViewGroup viewGroup, int i){
    ...
    @Override
    public void onBindViewHolder(MiViewHolder miViewHolder, int i) {
    ...
    public class MiViewHolder extends RecyclerView.ViewHolder{
        ...
        public MiViewHolder(@NonNull View itemView){
            super(itemView);
            tvNombrePlaya=itemView.findViewById(R.id.tvPlayas);
